...
class SignUp extends Component{
    ...
    submitLogin = async(e) => {
        ...
        if(resp.data.msg === "userExists"){
            swal({
                title: 'Email exists',
                text: 'The email address you provided already registered',
                icon: 'error',        
        })
        ...
        // const tokenurl = `${window.apiHost}/users/token-check`;
        // const tokenResp = await axios.post(tokenurl,{token});
...
//you can make this a separate component or you can write locally under export default line
